    ...
    <div class="page">
        <div class="cover-info">
            <div class="logo-container">
                <img src="logo.png" alt="<?php echo htmlspecialchars($societe['RaisonSociale']); ?>" class="logo">
            </div>
    ...
    <div class="page">
        <div class="total-section">
            ...
            <p style="margin-top: 1.5rem;">
                <strong>IBAN :</strong> FR76 1695 8000 0146 4557 4659 554<br>
                <strong>BIC/SWIFT :</strong> QNTOFRP1XXX
            </p>
        </div>
        ...
        <footer class="footer">
            <div class="footer-content">
                ...
                <p>Ce devis a été établi par ©Vrai Bois SARL</p>
                <p>Vrai Bois SARL - 922 270 889 00012</p>
                <p>Capital social : 1000 € - RCS Versailles</p>
            </div>
        </footer>
    </div>
